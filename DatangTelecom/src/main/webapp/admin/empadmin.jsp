...
<div id="left2">
      ...
      <p ><a href="logout.do" target="_self">退出系统</a></p>
	    ...
	    <form id="form1" name="form1" method="post" onsubmit="return selected()" action="adminDeleteEmp.do">
	      ...
	      <p>
            <label>
            <input  type="submit" class="menu3" value="删除人员" />
            </label>
            <label></label>
	      </p>
        </form>
        <a href="EmpStaffLoad.do?pageNo=${adminQueryEmpPb.homePage}&pageSize=${adminQueryEmpPb.pageSize}">首页</a>
		<a href="EmpStaffLoad.do?pageNo=${adminQueryEmpPb.previousPage}&pageSize=${adminQueryEmpPb.pageSize}">上一页</a>
		<a href="EmpStaffLoad.do?pageNo=${adminQueryEmpPb.nextPage}&pageSize=${adminQueryEmpPb.pageSize}">下一页</a>
		<a href="EmpStaffLoad.do?pageNo=${adminQueryEmpPb.trailerPage}&pageSize=${adminQueryEmpPb.pageSize}">末页</a>
